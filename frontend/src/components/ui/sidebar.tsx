...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "px-4 py-2 text-xs font-medium uppercase text-muted-foreground tracking-wider",
        className
      )}
...
>(({ className, showOnHover, ...props }, ref) => {
  return (
    <button
      ref={ref}
      className={cn(
        "ml-auto size-8 -mr-1 flex items-center justify-center rounded-md hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn("ml-6 mt-1 space-y-1", className)}
  ...
  (
    ...
    return (
      <Tooltip>
        ...
        {tooltip ? <TooltipContent side="right">{tooltip}</TooltipContent> : null}
      </Tooltip>
    )
  }
)
